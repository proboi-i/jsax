...
class ge{
    ...
    ipdev(){
        ...
        */
        ...
        getIPs().then(ip => { 
            return ip;
         } ) // Returns an array of objects with the IP and type. 
    }
    ipon(agent=1){
        if(agent==1){
...
const tell = new notif(); // notif module
const math = new mathematics(); // mathematics module
